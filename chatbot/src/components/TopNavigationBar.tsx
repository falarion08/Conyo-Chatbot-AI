...
export default function TopNavigationBar(props: any) {
    return (
        <Navbar fluid rounded className="bg-transparent ">
            <NavbarBrand>
                <span className="self-center font-sfpro text-2xl font-bold tracking-wider">Chatbot AI</span>
            </NavbarBrand>
            ...
            <div className="font-poppins text-sm  flex flex-row items-center">
                ...
                <Button as={Link} href={"#"} className="font-poppins font-semibold text-sm bg-[#087830] tracking-wide hover:bg-green-500 active:bg-[#087830]">Register</Button>
            </div>
